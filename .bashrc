...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[4;35m\]\u\[\033[0;32m\]@\[\033[1;31m\]\h\[\033[1;35m\]:\[\033[1;33m\]\w\[\033[1;36m\]$(__git_ps1)\$ '
else
...
export PATH="$PATH:$HOME/bin" # Add exercism to PATH for scripting
#source ~/bin/./exercism



export TERM=xterm-256color  #to enable 256 colors
